...
echo on
set mods= txt/MODULES.F90 txt/MODE_WRITE.F90
...
core/THERMAL.F90 core/TRIDIAG.F90 ^
txt/OPEN_FILES.F90 txt/CUMULATE.F90 txt/DRIVE.F90 txt/DUMP.F90 txt/PHYSICS.F90 txt/SETUP.F90 txt/OUTPUT.F90
